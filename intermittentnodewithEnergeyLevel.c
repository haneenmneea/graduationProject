...
/* Energy */
#define ENERGY_THRESHOLD     10   /* انطفاء عند 10%                       */
#define ENERGY_COST_IDLE      1   /* استهلاك ثابت كل دورة                */
#define ENERGY_COST_SEND_MIN  3   /* اقل تكلفة ارسال - اشارة ممتازة      */
#define ENERGY_COST_SEND_MAX  8   /* اعلى تكلفة ارسال - اشارة ضعيفة     */
#define ENERGY_HARVEST_PROB  85   /* 85/255 = 33% احتمال شحن             */
#define ENERGY_HARVEST_MAX    3   /* اعلى شحن ممكن في الدورة             */
#define ENERGY_INIT_MIN      30   /* اقل طاقة اولية                       */
#define ENERGY_INIT_MAX      60   /* اعلى طاقة اولية                      */
...
/*---------------------------------------------------------------------------*/
/* try_harvest — شحن عشوائي يحاكي حصاد الطاقة                               */
/*---------------------------------------------------------------------------*/
static void
try_harvest(void)
{
...
/*---------------------------------------------------------------------------*/
/* update_energy — خصم + harvest + log + reboot check                        */
/*---------------------------------------------------------------------------*/
static void
update_energy(uint8_t cost)
{
  ...
  /* هذا السطر هو بيانات التدريب للـ ML */
...
PROCESS_THREAD(udp_client_process, ev, data)
{
  ...
  /* jitter اولي لتجنب تصادم الرسائل */
